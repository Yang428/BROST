...
sys.path.append('/home/wcz/Yang/BROST/')

from pytracking.tracker.brost_vot20 import BROST
from pytracking.parameter.brost import brost_vot20 as vot_params
