...
def parameters():
    ...
    # Training parameters
    params.sample_memory_size = 260              # Memory size
    ...
    ## IouNet params ##
    params.image_sample_size = 22*20
    ...
    params.filter_sample_thr = 0.1
    params.iou_refine_thr = 0.4
    params.response_budget_sz = 25
    params.score_budget_sz = 10
