...
Signal Processing: Image Communication, 2023.[[paper]]([https://ieeexplore.ieee.org/document/10061440/](https://www.sciencedirect.com/science/article/abs/pii/S0923596523000632))
...
The segmentation network in BROST tracker is trained only on the YouTube VOS dataset. Download the VOS training dataset (2018 version) and copy the files vos-list-train.txt and vos-list-val.txt from ltr/data_specs to the training directory of the VOS dataset.
